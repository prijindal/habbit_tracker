...
class HabbitsList extends StatefulWidget {
  ...
  @override
  State<HabbitsList> createState() => _HabbitsListState();
}
...
class _HabbitsListState extends State<HabbitsList> {
  ...
  void _recordHabbit(BuildContext context) async {
      ...
      builder: (BuildContext context, BoxConstraints constraints) {
        if (constraints.maxWidth > mediaBreakpoint) {
          return FloatingActionButton.extended(
            onPressed: () => _recordHabbit(context),
            tooltip: "Habbit",
      ...
      child: ReorderableListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return AnimationConfiguration.staggeredList(
            key: Key("AnimationConfiguration Habbits ${habbit.id}"),
            position: index,
